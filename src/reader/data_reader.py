...
from src.videoproducer import VideoProducer
...
def read_file_by_chunks(sha_id: str, element_id: str, element_alias: str, unix_epoch: int):
    ...
    while read:
        video_producer.produce(VideoData(sha_id=sha_id, element_id=element_id, element_alias=element_alias,
