...
async def main():
    ...
    async with dagger.connection(cfg):
        ...
        repo_url = "https://github.com/Javier-Godon/kafka-video-server-python"
        ...
        image_address = f"ghcr.io/{username.lower()}/kafka-video-server-python:{image_tag}"
        ...
        payload = {
            "event_type": "image-tag-in-kafka-video-server-python-dev-updated",
            "client_payload": {
                "image_tag": image_tag
            }
        }
